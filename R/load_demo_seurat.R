...
#' Genomics PBMC3K dataset. It is intended for examples and package tests that
#' should use a recognizable public dataset without making the installed package
#' large.
#'
