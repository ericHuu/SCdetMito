...
#'
#' @description
#' `check_seu()` is exported as a small metadata validation utility for
#' advanced users and for backward compatibility with earlier SCdetMito
#' workflows. New mitochondrial-ratio workflows should prefer
#' [ensure_mito_ratio()] when the target column is mitochondrial content.
#'
