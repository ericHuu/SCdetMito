...
build_qc_provenance <- function(function_name,
  ...
  list(
    ...
    cutoff_applied = cutoff_applied %||% first_value("applied_cutoff", NA_real_),
    cutoff_applied_source = cutoff_applied_source %||% first_value("cutoff_applied_source", NA_character_),
    selected_cutoff = first_value("selected_cutoff", first_value("detected_cutoff", NA_real_)),
    recommended_cutoff = first_value("recommended_cutoff", NA_real_),
